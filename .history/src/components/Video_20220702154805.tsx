...
const Video = (props: VideoProps) => {
  ...
  const isLessonAvailable = isPast(data.lesson.availableAt);
  console.log("isLessonAvailable", data.lesson.availableAt);
  ...
  if (isLessonAvailable)
    ...
    return (
      <div className="flex flex-1 justify-center">
        <h1 className="font-bold text-2xl block mt-[20rem]">
          Conteúdo bloqueado!
        </h1>
      </div>
    );
